...
option(JUMPY_THIEVES_WARNING_AS_ERROR "Treats compiler warnings as errors" ON)
if (MSVC)
    target_compile_options(compiler_options INTERFACE /W4 "/permissive-")
    if (JUMPY_THIEVES_WARNING_AS_ERROR)
...
option(JUMPY_THIEVES_ENABLE_PCH "Enable Precompiled Headers" OFF)
if (JUMPY_THIEVES_ENABLE_PCH)
...
option(JUMPY_THIEVES_USE_ASAN "Enable the Address Sanitizers" OFF)
if (JUMPY_THIEVES_USE_ASAN)
...
option(JUMPY_THIEVES_USE_TSAN "Enable the Thread Sanitizers" OFF)
if (JUMPY_THIEVES_USE_TSAN)
...
option(JUMPY_THIEVES_USE_MSAN "Enable the Memory Sanitizers" OFF)
if (JUMPY_THIEVES_USE_MSAN)
...
option(JUMPY_THIEVES_USE_UBSAN "Enable the Undefined Behavior Sanitizers" OFF)
if (JUMPY_THIEVES_USE_UBSAN)
